...
public record PutConnectFourPieceC2CPacket(@Nullable String sender, @Nullable UUID senderUUID, int x) implements C2CPacket {
    ...
    public static final PacketType<PutConnectFourPieceC2CPacket> ID = new PacketType<>(PacketFlow.CLIENTBOUND, Identifier.fromNamespaceAndPath("clientcommands", "put_connect_four_piece"));
