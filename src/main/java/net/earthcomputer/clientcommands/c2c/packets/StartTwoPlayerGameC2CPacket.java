...
public record StartTwoPlayerGameC2CPacket(@Nullable String sender, @Nullable UUID senderUUID, boolean accept, TwoPlayerGame<?, ?> game) implements C2CPacket {
    ...
    public void write(C2CFriendlyByteBuf buf) {
        ...
        buf.writeIdentifier(this.game.getId());
    }
