...
public class AreaStatsCommand {
    ...
    private static int loop(int start1, int end1, int start2, int end2, int start3, int end3, ClientBlockPredicate predicate, LevelChunk chunk, BlockPos.MutableBlockPos mutablePos) {
        int counter = 0;
